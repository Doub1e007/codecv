...
export function useResumeType() {
  ...
  const resumeType = ref(route.query.type ? String(route.query.type) : 'ops_blue_timeline')
  onActivated(() => {
    resumeType.value = route.query.type ? String(route.query.type) : 'ops_blue_timeline'
  })
  return {
    resumeType
  }
